...
const company = {
  ...
  description: {
    ...
    part4:
      " Chaque œuvre d'Art est représentée par une copie numérique unique et sécurisée, permettant d'assurer ",
  ...
  title02:
    "Vos œuvres d'Art sont dispersées entre plusieurs lieux et la gestion de votre collection est souvent peu efficace.",
  description02: {
    part1:
      "Vous rencontrez des difficultés concernant la gestion de votre collection, notamment en matière de représentation, de transmission, de vente et d'assurance.",
    part2:
      'Vous souhaitez regrouper, sauvegarder et sécuriser au même endroit la documentation de vos œuvres et vous cherchez une solution innovante pour toutes ces raisons.',
    part3: 'Nous avons la solution pour vous avec Spicaro :',
    part4:
      'Découvrez une méthode continue, innovante et haut de gamme pour optimiser la gestion de votre collection tout en préservant son histoire.',
    part5:
      'Toutes vos données et vos collections sont protégées grâce à des technologies de pointe. Vos informations restent strictement confidentielles, avec des protocoles renforcés garantissant leur sécurité et leur intégrité à chaque étape.',
  },
