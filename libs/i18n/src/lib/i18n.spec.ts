...
describe('useTranslations', () => {
  ...
  it('should throw error for unsupported language', () => {
    ...
    expect(() =>
      useTranslations(lang, ['en', 'fr'], translationsMap, false, 'en'),
  ...
  it('should throw error if translations not found for language', () => {
    ...
    expect(() =>
      useTranslations(lang, ['en', 'fr', 'de'], translationsMap, false, 'en'),
...
describe('l function', () => {
  it('should return localized permalink for the specified slug', () => {
    const lang = 'en'
    ...
    expect(l('welcome')).toBe('/en/welcome')
    expect(l('goodbye')).toBe('/en/goodbye')
  })
})
